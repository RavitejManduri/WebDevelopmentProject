...
<%
    ...
    try 
    {
         ...
         String ins_sql="insert into online_faculty(Can_Name,Can_Email,Can_Password,Can_Phone,Can_Gender,Can_Birth,Can_Address,Can_City,Can_State,Can_Internship,Can_Description,Can_ContactedDate,Can_NextContactedDate) values('"+cName+"','"+cEmail+"','"+cPassword+"','"+cMobile+"','"+cGender+"','"+cBirth+"','"+cAddress+"','"+cCity+"','"+cState+"','"+cInternship+"','"+cDescription+"','"+cContacted+"','"+cNextDate+"')";
