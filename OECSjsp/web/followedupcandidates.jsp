...
<!-- container begins-->
 <div class="container">
   ...
   <!-- header ends-->
    <!-- content begins-->
    <div class="content">
      <h1 id="about">Telacaller</h1><div class="clear"></div><hr class="hr1" />
      <h1 style=" color: black"><b><center>FOLLOWEDUP CANDIDATE DETAILS </center></b></h1>
      <%@include  file="followedupcode.jsp" %>
      <br><br>
      <br><br>
      <br><br>
      <br><br>
