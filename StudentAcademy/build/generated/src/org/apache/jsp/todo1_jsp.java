...
public final class todo1_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("          }\n");
      out.write("          #content1,#content2,#content3,#content4,#content5,#content6 {\n");
      ...
      out.write("             width: 100%;\n");
      out.write("             background-color:#2E2F2F;\n");
      out.write("            \n");
...
if(date.equals("Mon")){
      ...
      out.write("           <div id=\"content1\" style=\"width:100%\">\n");
      out.write("                ");
String selsql="select * from todo where day='Monday' and rno='"+rno+"'";
                       ...
                       rs=ps.executeQuery();
                                     while(rs.next())
                      {
      out.write("<script>i1++;</script>\n");
      out.write("             <input type=\"text\" style=\"margin-left: 5px; width:90%;border-style: solid;border-width: 1px;margin-bottom:2px;\" value=\"");
      out.print(rs.getString("name"));
      out.write("\"  id=\"mon\"/>\n");
      out.write("             <script>var divid = document.getElementById('mon');\n");
      out.write("                 divid.id = 'mon'+i1;\n");
      out.write("             divid.name='mon'+i1   </script>\n");
      out.write("                 \n");
      out.write("            ");
   }
...
if(date.equals("Tue")){
      ...
      out.write("           <div id=\"content2\" style=\"width:100%\">\n");
      out.write("               \n");
      out.write("               ");
 selsql="select * from todo where day='Tuesday' and rno='"+rno+"'";
                       ...
                       rs=ps.executeQuery();
                                     while(rs.next())
                      {
      out.write("<script>i2++;</script>\n");
      out.write("             <input type=\"text\" style=\"margin-left: 5px; width:90%;border-style: solid;border-width: 1px;margin-bottom:2px;\" value=\"");
      out.print(rs.getString("name"));
      out.write("\"  id=\"tue\"/>\n");
      out.write("             <script>var divid = document.getElementById('tue');\n");
      out.write("                 divid.id = 'tue'+i2;\n");
      out.write("             divid.name='tue'+i2;   </script>\n");
      out.write("                 \n");
      out.write("            ");
   }
...
if(date.equals("Wed")){
      ...
      out.write("text-decoration:none;\"> <b>Wednesday</b></p>\n");
      out.write("   \n");
      out.write("       <center>\n");
      out.write("                       \n");
      ...
      out.write("           <div id=\"content3\" style=\"width:100%\">\n");
      out.write("               \n");
      out.write("                  ");
 selsql="select * from todo where day='Wednesday' and rno='"+rno+"'";
                       ...
                       rs=ps.executeQuery();
                                     while(rs.next())
                      {
      out.write("<script>i3++;</script>\n");
      out.write("             <input type=\"text\" style=\"margin-left: 5px; width:90%;border-style: solid;border-width: 1px;margin-bottom:2px;\" value=\"");
      out.print(rs.getString("name"));
      out.write("\"  id=\"wed\"/>\n");
      out.write("             <script>var divid = document.getElementById('wed');\n");
      out.write("                 divid.id = 'wed'+i3;\n");
      out.write("             divid.name='wed'+i3;   </script>\n");
      out.write("                 \n");
      out.write("            ");
   }
...
if(date.equals("Thu")){
      ...
      out.write("           <div id=\"content4\" style=\"width:100%\">\n");
      out.write("               \n");
      out.write("                ");
 selsql="select * from todo where day='Thursday' and rno='"+rno+"'";
                       ...
                       rs=ps.executeQuery();
                                     while(rs.next())
                      {
      out.write("<script>i4++;</script>\n");
      out.write("             <input type=\"text\" style=\"margin-left: 5px; width:90%;border-style: solid;border-width: 1px;margin-bottom:2px;\" value=\"");
      out.print(rs.getString("name"));
      out.write("\"  id=\"thu\"/>\n");
      out.write("             <script>var divid = document.getElementById('thu');\n");
      out.write("                 divid.id = 'thu'+i4;\n");
      out.write("             divid.name='thu'+i4;   </script>\n");
      out.write("                 \n");
      out.write("            ");
   }
...
if(date.equals("Fri")){
      ...
      out.write("           <div id=\"content5\" style=\"width:100%\">\n");
      out.write("               \n");
      out.write("                ");
 selsql="select * from todo where day='Friday' and rno='"+rno+"'";
                       ...
                       rs=ps.executeQuery();
                                     while(rs.next())
                      {
      out.write("<script>i5++;</script>\n");
      out.write("             <input type=\"text\" style=\"margin-left: 5px; width:90%;border-style: solid;border-width: 1px;margin-bottom:2px;\" value=\"");
      out.print(rs.getString("name"));
      out.write("\"  id=\"fri\"/>\n");
      out.write("             <script>var divid = document.getElementById('fri');\n");
      out.write("                 divid.id = 'fri'+i5;\n");
      out.write("             divid.name='fri'+i5;   </script>\n");
      out.write("                 \n");
      out.write("            ");
   }
...
if(date.equals("Sat")){
      ...
      out.write("           <div id=\"content6\" style=\"width:100%\">\n");
      out.write("               \n");
      out.write("                ");
 selsql="select * from todo where day='Saturday' and rno='"+rno+"'";
                       ...
                       rs=ps.executeQuery();
                                     while(rs.next())
                      {
      out.write("<script>i6++;</script>\n");
      out.write("             <input type=\"text\" style=\"margin-left: 5px; width:90%;border-style: solid;border-width: 1px;margin-bottom:2px;\" value=\"");
      out.print(rs.getString("name"));
      out.write("\"  id=\"sat\"/>\n");
      out.write("             <script>var divid = document.getElementById('sat');\n");
      out.write("                 divid.id = 'sat'+i6;\n");
      out.write("             divid.name='sat'+i6;   </script>\n");
      out.write("                 \n");
      out.write("            ");
   }
